...
async def on_item_quantity_input(
    ...
    try:
        added_item = await api_client.add_inventory_item(character_id, new_item)
...
async def on_edit_item_name(
    ...
    try:
        await api_client.update_inventory_item(item_id, update_data)
...
async def on_delete_inventory_item(
    ...
    try:
        await api_client.delete_inventory_item(item_id)
