...
class StubAPIClient:
        ...
        self._inventory = {
            1: [
                InventoryItem(
                    id=1,
                    name="Меч Андрила",
                    description="Легендарный меч, светящийся в присутствии орков",
                    quantity=1,
                ),
                InventoryItem(
                    id=2,
                    name="Кольцо Духа",
                    description="Увеличивает мудрость на +2",
                    quantity=1,
                ),
                InventoryItem(
                    id=3, name="Золотые монеты", description="", quantity=150
                ),
            ],
            2: [
                InventoryItem(
                    id=4,
                    name="Посох Мага",
                    description="Увеличивает силу заклинаний на 20%",
                    quantity=1,
                ),
                InventoryItem(
                    id=5, name="Свиток огненного шара", description="", quantity=3
                ),
            ],
            3: [
                InventoryItem(
                    id=6,
                    name="Лук Галадриэли",
                    description="Эльфийский лук невероятной точности",
                    quantity=1,
                ),
    ...
    async def get_character(self, character_id: int) -> CharacterDetail:
        ...
        return CharacterDetail(**character.dict(), inventory=inventory)
